...
impl PoseidonSbox {
	...
	/// Takes in an element of a prime field and raises it to the power alpha (`sbox.0`)
	/// within that field. The method assumes that alpha is either 3, 5, 17, or -1.
	/// If not, it throws `PoseidonError`.
