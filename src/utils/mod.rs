...
#[cfg(feature = "poseidon_bn254_x3_3")]
pub fn get_width_poseidon_bn254_x3_3<F: PrimeField>() -> Vec<Vec<F>> {
	parse_vec(bn254_x3_3::WIDTH.to_vec())

}

#[cfg(feature = "poseidon_bn254_x3_5")]
pub fn get_width_poseidon_bn254_x3_5<F: PrimeField>() -> Vec<Vec<F>> {
	parse_vec(bn254_x3_5::WIDTH.to_vec())

}

#[cfg(feature = "poseidon_bn254_x5_2")]
pub fn get_width_poseidon_bn254_x5_2<F: PrimeField>() -> Vec<Vec<F>> {
	parse_vec(bn254_x5_2::WIDTH.to_vec())

}

#[cfg(feature = "poseidon_bn254_x5_3")]
pub fn get_width_poseidon_bn254_x5_3<F: PrimeField>() -> Vec<Vec<F>> {
	parse_vec(bn254_x5_3::WIDTH.to_vec())

}

#[cfg(feature = "poseidon_bn254_x5_4")]
pub fn get_width_poseidon_bn254_x5_4<F: PrimeField>() -> Vec<Vec<F>> {
	parse_vec(bn254_x5_4::WIDTH.to_vec())

}

#[cfg(feature = "poseidon_bn254_x5_5")]
pub fn get_width_poseidon_bn254_x5_5<F: PrimeField>() -> Vec<Vec<F>> {
	parse_vec(bn254_x5_5::WIDTH.to_vec())

}

//TODO: Check if values are defined correctly
#[cfg(feature = "poseidon_bn254_x17_3")]
pub fn get_width_poseidon_bn254_x17_3<F: PrimeField>() -> Vec<Vec<F>> {
	parse_vec(bn254_x17_3::WIDTH.to_vec())

}

#[cfg(feature = "poseidon_bn254_x17_5")]
pub fn get_width_poseidon_bn254_x17_5<F: PrimeField>() -> Vec<Vec<F>> {
	parse_vec(bn254_x17_5::WIDTH.to_vec())
